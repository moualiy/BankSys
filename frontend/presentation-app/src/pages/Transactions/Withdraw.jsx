...
const Withdraw = () => {
  ...
  const { loading, error, request: withdraw } = useApi();
  ...
  const handleWithdraw = async (e) => {
    ...
    try {
      ...
      await withdraw('post', '/transactions/withdraw', { clientId: parsedClientId, amount: parsedAmount });
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-3xl font-bold text-blue-600 dark:text-blue-400">Withdraw</h1>
